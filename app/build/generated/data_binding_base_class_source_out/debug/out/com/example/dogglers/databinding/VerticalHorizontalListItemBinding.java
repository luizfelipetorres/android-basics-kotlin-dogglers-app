...
public final class VerticalHorizontalListItemBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView hobbyItem;
  ...
  private VerticalHorizontalListItemBinding(@NonNull MaterialCardView rootView,
      @NonNull TextView ageItem, @NonNull TextView hobbyItem, @NonNull ImageView imageItem,
  ...
  public static VerticalHorizontalListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.hobby_item;
      TextView hobbyItem = ViewBindings.findChildViewById(rootView, id);
      if (hobbyItem == null) {
        break missingId;
      }
      ...
      return new VerticalHorizontalListItemBinding((MaterialCardView) rootView, ageItem, hobbyItem,
          imageItem, nameItem);
    }
